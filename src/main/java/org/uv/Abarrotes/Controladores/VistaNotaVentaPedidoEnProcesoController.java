...
//        List<VistaNotaVentaPedidoEnProceso> notasEnProceso = vistaNotaVentaPedidoEnProcesoService
//                .getVistaNotaVentaPedidoEnProcesoByEstado("En Proceso");

//        return ResponseEntity.ok(notasEnProceso);
    }
}
