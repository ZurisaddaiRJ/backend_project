...
import org.uv.Ferreteria.servicio.OpcionesRolService;
...
public class OpcionesRolController {
    ...
    @PostMapping
    public ResponseEntity<org.uv.Ferreteria.DTOs.DTOOpcionesRol> crearOpcionRolConEntidades(@Valid @RequestBody OpcionesRol nuevaopcionRol) {
        org.uv.Ferreteria.DTOs.DTOOpcionesRol opcionrolCreado = opcionesRolService.crearOpcionRol(nuevaopcionRol);
