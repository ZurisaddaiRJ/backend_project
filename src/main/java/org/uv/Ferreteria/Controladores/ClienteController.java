...
import org.uv.Ferreteria.servicio.ClienteService;
/**
 *
 * @author yacruz
 */
...
public class ClienteController {
    ...
    @PostMapping
    public ResponseEntity<org.uv.Ferreteria.DTOs.DTOCliente> crearClienteConEntidades(@Valid @RequestBody Cliente nuevoCliente) {
        org.uv.Ferreteria.DTOs.DTOCliente clienteCreado = clienteService.crearCliente(nuevoCliente);
